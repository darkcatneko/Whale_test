            ...
            else
            {
                ...
                else
                {
                    if (InRage == false)
                    {
                        ...
                        {
                            Debug.Log("普攻A預兆");
                            BossAction.AddListener(() => { Controller.BossAnimation(0, 0);  Controller.AttackUsedTime = Controller.BossAnimationTime(0, 0); Controller.BossAttackDamage(1.2f); BossAction.RemoveAllListeners(); });//普攻A轟出
                        }
                        else if (a <= 60)
                        {
                            Debug.Log("普攻B預兆");
